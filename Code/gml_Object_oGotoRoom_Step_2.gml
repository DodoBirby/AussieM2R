var targetwidth;
if (((direction == 0 || direction == 180) && oCharacter.y <= (y + 16) && oCharacter.y > (y - height - 16)) || ((direction == 90 || direction == 270) && oCharacter.x >= x && oCharacter.x < (x + height) && global.spectatorIndex == -1))
{
