...
if (chargebeam < 1)
    chargebeam = 0
var modifier = 0
if (45 <= argument0 && argument0 <= 135) {
    modifier = -4
}
if (225 <= argument0 && argument0 <= 315) {
    modifier = 6
}
instance_create((x + aspr2x), (y - aspr2y - 39 + modifier), oMflash)
beamX = oMflash.x
beamY = oMflash.y
beams = 1
...
repeat beams
{
    beam = instance_create((x + aspr2x), (y - aspr2y - 39), oBeam)
    beam.sax = global.sax
