kRight = oControl.kLeft
kRightPushedSteps = oControl.kLeftPushedSteps
kRightPressed = oControl.kLeftPressed
kRightReleased = oControl.kLeftReleased
kLeft = oControl.kRight
kLeftPushedSteps = oControl.kRightPushedSteps
kLeftPressed = oControl.kRightPressed
kLeftReleased = oControl.kRightReleased
kUp = oControl.kUp
...
if (global.opmslstyle == 1)
{
    if (kMissile && kMissilePushedSteps == 1 && global.maxmissiles > 0 && (global.missiles > 0 || global.smissiles > 0 || global.pbombs > 0))
    {
        ...
        if (global.currentweapon == 1 && global.missiles == 0)
            global.currentweapon += 1
        if (global.currentweapon == 2 && (global.maxsmissiles == 0 || global.smissiles == 0))
            global.currentweapon += 1
        if (global.currentweapon == 3 && (global.maxpbombs == 0 || global.pbombs == 0))
            global.currentweapon += 1
